                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">ادارة نتائج الطلاب</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li> نتائج الطلاب</li>
            							<li class="active">ادارة نتائج الطلاب</li>
            						</ul>
                                </div>
    ...
    <div class="alert alert-danger left-icon-alert" role="alert">
                                        ...
                                        <?php } ?>
                                            <div class="panel-body p-20">
                                                ...
                                                <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="130%">
                                                    <thead>
                                                        <tr>
                                                            <th>م</th>
                                                            <th>اسم الطاليب</th>
