                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">اضافة المواد الدراسية للفصول</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        <li><a href="dashboard.php"><i class="fa fa-home"></i> الرئيسة</a></li>
                                        <li> المواد الدراسية</li>
                                        <li class="active">اضافة المواد الدراسية للفصول</li>
                                    </ul>
                                </div>
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>اضافة المواد الدراسية للفصول</h5>
                                                </div>
                                            </div>
                                        ...
                                        <?php } ?>
                                                <form class="form-horizontal" method="post">
                                                    <div class="form-group">
                                                        <label style="float:right" for="default" class="col-sm-2 control-label">الفصل الدراسي</label>
                                                        <div class="col-sm-10">
 <select name="class" class="form-control" id="default" required="required">
<option value="">بحث فصل دراسي</option>
...
<div class="form-group">
                                                        <label style="float:right" for="default" class="col-sm-2 control-label">المادة الدراسية</label>
                                                        <div class="col-sm-10">
 <select name="subject" class="form-control" id="default" required="required">
<option value="">بحث مادة</option>
