                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">تعديل بيانات الطالب</li>
                                    </ul>
                                </div>
...
<label style="float:right" for="default" class="col-sm-2 control-label">اسم الطالب</label>
<div class="col-sm-10">
...
<div class="form-group">
<label style="float:right" for="default" class="col-sm-2 control-label">الرقم التعريفي</label>
<div class="col-sm-10">
...
<div class="form-group">
<label style="float:right" for="default" class="col-sm-2 control-label">ايميل الطالب</label>
<div class="col-sm-10">
...
<div class="form-group">
<label style="float:right" for="default" class="col-sm-2 control-label">الجنس</label>
<div class="col-sm-10">
<?php  $gndr=$result->Gender;
if($gndr=="Male")
{
?>
<input type="radio" name="gender" value="Male" required="required" checked>ذكر <input type="radio" name="gender" value="Female" required="required">انثى 
<?php }?>
<?php  
if($gndr=="Female")
{
?>
<input type="radio" name="gender" value="Male" required="required" >ذكر <input type="radio" name="gender" value="Female" required="required" checked>انثى 
<?php }?>
<?php  
if($gndr=="Other")
{
?>
<input type="radio" name="gender" value="Male" required="required" >ذكر <input type="radio" name="gender" value="Female" required="required">انثى
<?php }?>
                                                    ...
                                                    <div class="form-group">
                                                        <label style="float:right" for="default" class="col-sm-2 control-label">الصف الدارسي</label>
                                                        <div class="col-sm-10">
...
<div class="form-group">
                                                        <label style="float:right" for="date" class="col-sm-2 control-label">تاريخ الميلاد</label>
                                                        <div class="col-sm-10">
                <input type="date"  name="dob" class="form-control" value="<?php echo htmlentities($result->DOB)?>" id="date">
                                                        </div>
                                                    </div>
<div class="form-group">
<label style="float:right" for="default" class="col-sm-2 control-label">تاريخ الانشاء: </label>
<div class="col-sm-10">
...
<div class="form-group">
<label style="float:right" for="default" class="col-sm-2 control-label">الحالة</label>
<div class="col-sm-10">
<?php  $stats=$result->Status;
if($stats=="1")
{
?>
<input type="radio" name="status" value="1" required="required" checked>نشط <input type="radio" name="status" value="0" required="required">غير نشط 
<?php }?>
<?php  
if($stats=="0")
{
?>
<input type="radio" name="status" value="1" required="required" >نشط <input type="radio" name="status" value="0" required="required" checked>غير نشط 
<?php }?>
