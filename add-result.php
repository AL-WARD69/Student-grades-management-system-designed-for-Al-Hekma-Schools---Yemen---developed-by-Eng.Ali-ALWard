...
{
$error="عذار حصل خطأ تاكد من كتابة البيانات بشكل صحيح";
}
}
}
?>
                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">اضافة نتيجة للطالب</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">نتائج الطلاب</li>
                                    </ul>
                                </div>
...
<label style="float:right" for="default" class="col-sm-2 control-label">حدد الصف الدارسي</label>
 <div class="col-sm-10">
 <select name="class" class="form-control clid" id="classid" onChange="getStudent(this.value);" required="required">
<option value="">حدد الصف الدارسي</option>
...
<div class="form-group">
                                                        <label style="float:right" for="date" class="col-sm-2 control-label ">حدد اسم الطالب</label>
                                                        <div class="col-sm-10">
...
<div class="form-group">
                                                        <label style="float:right" for="date" class="col-sm-2 control-label">المواد الدراسية</label>
                                                        <div class="col-sm-10">
                                                    <div  id="subject">
                                                    </div>
                                                        </div>
