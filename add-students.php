...
{
$error="تأكد من كتابة البيانات بشكل صحيح";
}
...
<label style="float:right" for="default" class="col-sm-2 control-label">الاسم الرباعي</label>
<div class="col-sm-10">
...
<div class="form-group">
<label style="float:right" for="default" class="col-sm-2 control-label">الرقم التعريفي للطالب</label>
<div class="col-sm-10">
