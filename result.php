                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-12">
                                    <h2 class="title" align="center">نتائج الطلاب</h2>
                                </div>
                            </div>
                            <!-- /.row -->
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h3 align="center">تفاصيل نتيجة الطالب</h3>
                                                    <hr />
<?php
// code Student Data
$rollid=$_POST['rollid'];
...
{   ?>
<p><b>اسم الطالب :</b> <?php echo htmlentities($row->StudentName);?></p>
<p><b>الرقم التعريفي:</b> <?php echo htmlentities($row->RollId);?>
<p><b>الصف الدراسي:</b> <?php echo htmlentities($row->ClassName);?>(<?php echo htmlentities($row->Section);?>)
<?php }
...
?>
<tr>
<th scope="row" colspan="2" style="text-align: center">مجموع الدرجة</th>
<td style="text-align: center"><b><?php echo htmlentities($totlcount); ?></b>  <b><?php echo htmlentities($outof=($cnt-1)*100); ?></b></td>
                                                        </tr>
<tr>
...
حصل خطأ تاكد من كتابة الرقم التعريفي للطالب</strong>
<?php
echo htmlentities("");
 }
?>
