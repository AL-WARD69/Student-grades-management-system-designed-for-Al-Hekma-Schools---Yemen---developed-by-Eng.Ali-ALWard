                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">تعديل الفصل للطالب</h2>
                                </div>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
            							...
            							<li><a href="#">الفصول الدراسية</a></li>
            							<li class="active">تعديل الفصل</li>
            						</ul>
                                </div>
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>تعديل الفصل للطالب</h5>
                                                </div>
                                            </div>
<?php if($msg){?>
<div class="alert alert-success left-icon-alert" role="alert">
 <strong>تم التعديل بنجاح</strong><?php echo htmlentities($msg); ?>
 </div><?php } 
else if($error){?>
    <div class="alert alert-danger left-icon-alert" role="alert">
                                            <strong>عذرا حصل خطا تاكد من كتابه البيانات بشكل صحيح</strong> <?php echo htmlentities($error); ?>
                                        </div>
                                        <?php } ?>
...
{   ?>
                                                    ...
                                                    <div class="form-group has-success">
                                                       ...
                                                       <div class="form-group has-success">
                                                        <label for="success" class="control-label">رقم الفصل الدارسي</label>
                                                        <div class="">
                                                     ...
                                                     <div class="form-group has-success">
                                                        <label for="success" class="control-label">القسم بالحروف</label>
                                                        <div class="">
  ...
  <div class="form-group has-success">
                                                        ...
                                                        <div class="">
                                                           <button type="submit" name="update" class="btn btn-success btn-labeled">تعديل<span class="btn-label btn-label-right"><i class="fa fa-check"></i></span></button>
                                                    </div>
