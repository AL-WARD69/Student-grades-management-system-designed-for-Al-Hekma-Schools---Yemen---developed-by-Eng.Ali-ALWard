                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">ادارة الطلاب</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li> الطلاب</li>
            							<li class="active">ادارة الطلاب</li>
            						</ul>
                                </div>
    ...
    <div class="alert alert-danger left-icon-alert" role="alert">
                                        ...
                                        <?php } ?>
                                            <div class="panel-body p-20">
                                                ...
                                                <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="120%">
                                                    <thead>
                                                        <tr>
                                                            <th>م</th>
                                                            <th>اسم الطالب</th>
...
echo htmlentities('Active');
   ...
   echo htmlentities('Blocked'); 
                                                                ...
                                                                ?></td>
<td>
<a href="edit-student.php?stid=<?php echo htmlentities($result->StudentId);?>" class="btn btn-primary btn-xs" target="_blank">تعديل </a> 

<a href="edit-result.php?stid=<?php echo htmlentities($result->StudentId);?>" class="btn btn-warning btn-xs" target="_blank">عرض النتيجة </a> 
